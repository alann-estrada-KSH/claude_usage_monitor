enum AccountProviderType {
  ...
  String get displayName => switch (this) {
    ...
    AccountProviderType.openCodeGo => 'OpenCode Go',
  };
  ...
  String get defaultLoginUrl => switch (this) {
    ...
    AccountProviderType.openCodeGo => 'https://opencode.ai/auth',
  };
  ...
  String get cookieDomainUrl => switch (this) {
    ...
    AccountProviderType.openCodeGo => 'https://opencode.ai',
  };
  ...
  static AccountProviderType fromString(String? val) {
    ...
    if (val == 'openCodeGo') return AccountProviderType.openCodeGo;
